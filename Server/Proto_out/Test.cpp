...
void protobuf_AssignDesc_Test_2eproto() {
  ...
  PBTest_reflection_ =
    new ::google::protobuf::internal::GeneratedMessageReflection(
      ...
      GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(PBTest, _unknown_fields_),
      -1,
...
const int PBTest::kPwdFieldNumber;
#endif  // !_MSC_VER
