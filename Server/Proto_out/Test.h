...
// optional string pwd = 3;
inline bool PBTest::has_pwd() const {
  return (_has_bits_[0] & 0x00000004u) != 0;
}
inline void PBTest::set_has_pwd() {
  _has_bits_[0] |= 0x00000004u;
}
inline void PBTest::clear_has_pwd() {
  _has_bits_[0] &= ~0x00000004u;
}
inline void PBTest::clear_pwd() {
  if (pwd_ != &::google::protobuf::internal::kEmptyString) {
    pwd_->clear();
  }
  clear_has_pwd();
}
inline const ::std::string& PBTest::pwd() const {
  return *pwd_;
}
inline void PBTest::set_pwd(const ::std::string& value) {
  set_has_pwd();
  if (pwd_ == &::google::protobuf::internal::kEmptyString) {
    pwd_ = new ::std::string;
  }
...
inline void PBTest::set_pwd(const char* value) {
  set_has_pwd();
  if (pwd_ == &::google::protobuf::internal::kEmptyString) {
    pwd_ = new ::std::string;
  }
...
inline void PBTest::set_pwd(const char* value, size_t size) {
  set_has_pwd();
  if (pwd_ == &::google::protobuf::internal::kEmptyString) {
    pwd_ = new ::std::string;
  }
...
inline ::std::string* PBTest::mutable_pwd() {
  set_has_pwd();
  if (pwd_ == &::google::protobuf::internal::kEmptyString) {
    pwd_ = new ::std::string;
  }
...
inline ::std::string* PBTest::release_pwd() {
  clear_has_pwd();
  if (pwd_ == &::google::protobuf::internal::kEmptyString) {
    return NULL;
  } else {
...
inline void PBTest::set_allocated_pwd(::std::string* pwd) {
  if (pwd_ != &::google::protobuf::internal::kEmptyString) {
    delete pwd_;
  }
  if (pwd) {
